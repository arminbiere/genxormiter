...
"The generator prints on '<stdout>' the miter between two parity circuits\n"
"over the given number of shared '<inputs>'.  The DIMACS encoding of\n"
"the input variables as well as the order of the temporary variables\n"
"introduced for the XOR gates in both circuits is completely random based\n"
"on the given seed.  Without any seed specified we generate one based on\n"
"the number of clock ticks of the processor and the current time.\n"
"\n"
"The generated instances can be solved through XOR reasoning (as in\n"
"'Lingeling'), as well as trivially with congruence closure if '-s' is\n"
"specified, which forces the two circuits two reduce inputs in the same way.\n"
"Interesting enough, if the two circuits reduce the inputs in a reverse\n"
"order (with '-r'), thus in essence we generate a miter between a left-\n"
"versus right-associative parity reduction, the instance is still solved\n"
"(apparently with the help of bounded variable elimination).\n"
"\n"
